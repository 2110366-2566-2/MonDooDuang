...
CREATE TYPE appointment_status_enum AS ENUM('CREATED', 'WAITING_FOR_PAYMENT', 'WAITING_FOR_EVENT', 'EVENT_COMPLETED', 'PAYMENT_COMPLETED', 
                                            'FORTUNE_TELLER_DECLINED', 'PAYMENT_EXPIRED', 'USER_CANCELED', 'SUSPENDED', 'NO_FRAUD_DETECTED', 'REFUNDED');
